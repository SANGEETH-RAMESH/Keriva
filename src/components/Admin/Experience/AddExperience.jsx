...
import { addExperiences } from "../../../services/adminService";
...
export default function AddExperience({ onSave, onCancel }) {
  const [form, setForm] = useState({ title: "", desc: "", price: "", duration: "" });
  ...
  return (
    <>
      <style>{`
        ...
        .add-modal-scroll::-webkit-scrollbar { width: 5px; }
        .add-modal-scroll::-webkit-scrollbar-thumb { background: #ddd; border-radius: 10px; }
        .upload-zone {
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12, color: "#aaa", marginTop: 2 }}>
              Fill in the details for the new journey.
            </div>
          </div>
          <button
            onClick={onCancel}
        ...
        <div style={{ padding: "24px 28px 28px" }}>
          ...
          <Field label="Experience Image" error={errors.image}>
            ...
            {!preview && (
              <div
                className={`upload-zone${dragging ? " dragging" : ""}${errors.image ? " has-error" : ""}`}
